...
create table pds2 (
	...
	fName 		varchar(250) not null,			 		/* 업로드시의 파일명 */
	fSName 		varchar(250) not null,					/* 실제 파일서버에 저장되는 파일명 */
...
create table review (
	...
	part		varchar(20) not null,							/* 분야..(board:게시판, pds2:자료실...) */
	partIdx	int not null,											/* 해당 분야의 고유번호 */	
	mid			varchar(30) not null,							/* 리뷰 올린이 */
	star		int not null default 0,						/* 별점 부여 */
	content text,															/* 리뷰 내용 */
