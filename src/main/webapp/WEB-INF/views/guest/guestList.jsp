...
<div class="container">
  ...
  <table class="table table-borderless">
    <tr>
      <td>
        <c:if test="${sAdmin != 'adminOk'}"><a href="adminLogin" class="btn btn-secondary">관리자</a></c:if>
        <c:if test="${sAdmin == 'adminOk'}"><a href="adminLogout" class="btn btn-secondary">관리자 로그아웃</a></c:if>
      </td>
