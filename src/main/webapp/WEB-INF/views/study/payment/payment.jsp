...
<div class="container">
  ...
  <form name="myform" method="post">
    ...
    <table class="table table-bordered">
      ...
      <tr>
	      <th>이메일</th>
	      <td><input type="text" name="buyer_email" value="apple_1114@naver.com" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주문자</th>
	      <td><input type="text" name="buyer_name" value="오소정" class="form-control"/></td>
      </tr>
      <tr>
	      <th>연락처</th>
	      <td><input type="text" name="buyer_tel" value="010-7365-9853" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주소</th>
