...
<head>
  ...
  <script>
    ...
    function fNewForm() {
    	...
    	str += '<input type="submit" value="회원가입" class="btn btn-info form-control"/>';
    	str += '<input type="button" onclick="transaction2()" value="회원가입2" class="btn btn-success mt-2 form-control"/>';
    	str += '</td>';
    	str += '</tr>';
    	str += '</table>';
    	str += '</form>';
