  ...
  <div>
    <p>학습할 차트를 선택하세요
      <select name="part" id="part" onchange="chartChange()">
        ...
        <option value="pie3D"    ${part == 'pie3D'    ? 'selected' : ''}>3D원형</option>
        <option value="pieDonut" ${part == 'pieDonut' ? 'selected' : ''}>도우넛</option>
        ...
        <option value="timeline" ${part == 'timeline' ? 'selected' : ''}>Timeline차트</option>
      </select>
    </p>
    <hr/>
    <div>
